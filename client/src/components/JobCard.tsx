  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='mt-4 flex gap-4 text-sm'>
        <button onClick={() => { navigate(`/apply-job/${job._id}`); scrollTo(0, 0) }} className='bg-blue-600 hover:bg-blue-700 duration-200 cursor-pointer text-white px-4 py-2 rounded'>Apply now</button>
