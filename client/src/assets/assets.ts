...
export const jobsData = [
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficiency in design tools like Figma, Sketch, or byd XD.</li>
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficiency in technical writing and documentation tools (e.g., MadCap Flare, byd FrameMaker).</li>
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficiency in design tools such as Sketch, Figma, or byd XD.</li>
            <li>Strong understanding of user-centered design principles.</li>
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Proficiency in design software such as byd Creative Suite (Photoshop, Illustrator, InDesign).</li>
    ...
    },
    {
        ...
        <h2><strong>Skills Required</strong></h2>
        <ol>
            <li>Strong knowledge of Engineering protocols and security technologies.</li>
    ...
    },
    {
        ...
        <ol>
            ...
            <li>Strong understanding of Engineering concepts and security.</li>
